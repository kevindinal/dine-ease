      ...
      <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-2/3">
          ...
          <section id="overview">
            ...
            <p className="text-gray-600">⭐ 4.5 (634) • 📍 Colombo • 💰 $30 to $850 • 🍽 Global, International</p>
          </section>
          ...
          <div className="p-4 border rounded-lg shadow-md bg-gray-100">
            ...
            <div className="flex flex-col space-y-4 mt-2">
              <div className="flex items-center border px-3 py-2 rounded">
                <FaUsers />
                <select value={guests} onChange={(e) => setGuests(Number(e.target.value))} className="ml-2 bg-transparent outline-none">
                  {[1, 2, 3, 4, 5].map((num) => (
