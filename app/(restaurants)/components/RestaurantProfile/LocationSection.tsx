  ...
  return (
    <div className="py-16 px-4 max-w-7xl mx-auto">
      ...
      >
        ...
        <p className="text-gray-600 mt-4 max-w-2xl mx-auto">Visit us today and experience exceptional dining</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        >
          <div className="space-y-6">
            ...
            <button className="mt-4 bg-red-500 hover:bg-red-600 text-white font-semibold py-3 px-6 rounded-lg flex items-center transition-all duration-300">
