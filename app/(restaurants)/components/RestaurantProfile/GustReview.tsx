  ...
  return (
    <div className="py-16 bg-gray-50 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Guest Reviews</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviewsToDisplay.map((review, index) => (
            ...
            >
              <div className="absolute -top-4 -left-4 bg-red-500 text-white p-3 rounded-full">
        ...
        <div className="text-center mt-10">
          <button className="border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white font-semibold py-3 px-8 rounded-full transition-all duration-300">
            View All Reviews
          </button>
        </div>
      </div>
