...
const mockReservations: Reservation[] = [
  { id: "1", date: "2024-03-20", time: "19:00", guests: 4, status: "confirmed" },
  { id: "2", date: "2024-03-22", time: "20:30", guests: 2, status: "pending" },
  { id: "3", date: "2024-03-25", time: "18:00", guests: 6, status: "confirmed" },
];
...
const ReservationsPage = () => {
  ...
  const handleCancel = async (id: string) => {
    ...
    try {
      ...
      toast({ title: "Reservation cancelled", description: "Your reservation has been cancelled successfully." });
    } catch {
      toast({ variant: "destructive", title: "Error", description: "Failed to cancel reservation. Please try again." });
    } finally {
      setIsLoading(false);
    }
  };
              ...
              {reservations.map((reservation) => (
                ...
                >
                  ...
                  <div className="flex space-x-2 w-full md:w-auto">
                    {reservation.status !== "cancelled" && (
                      <>
                        <Button variant="outline" size="sm" className="flex-1 md:flex-none" disabled={isLoading}>
                          <PencilLine className="w-4 h-4 mr-2" /> Modify
                        </Button>
                        <Button
                          variant="destructive"
                          size="sm"
