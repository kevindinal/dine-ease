    ...
    <div className="flex items-center justify-center px-2">
      ...
      >
        ...
        <div className="p-3 sm:p-6">
          <p className="font-bold text-gray-700 text-lg sm:text-[22px] leading-6 sm:leading-7 mb-1">{name}</p>
          <div className="flex flex-row">
            <p className="text-[#3C3C4399] text-sm sm:text-[17px] mr-2">★ {rating}</p>
          </div>
          <p className="text-[#7C7C80] text-sm sm:text-[15px] mt-4 sm:mt-6 line-clamp-2">{description}</p>
