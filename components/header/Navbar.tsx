...
import OrderStatusPopup from "./order-status/OrderStatusPopup"
...
const Navbar = () => {
  ...
  return (
    <>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              >
                ...
                >
                  ...
                  <span className="text-white font-medium hidden sm:inline">Order Status</span>
                  {/* Animated sparkle */}
                  <motion.div
                    animate={{
                      rotate: [0, 15, -15, 0],
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  >
                    <Button
                      variant="ghost"
                      className="w-full justify-start text-white hover:bg-[#FA4032]/50 transition-colors duration-200 group mt-2"
                      onClick={() => {
                        setIsOrderStatusOpen(true)
                        setIsMobileMenuOpen(false)
                      }}
                    >
                      <Coffee className="mr-2 h-4 w-4 group-hover:rotate-12 transition-transform duration-300" />
                      Order Status
                    </Button>
                  </motion.div>
      ...
      {/* Order Status Popup - Centered on the page */}
      <AnimatePresence>
        {isOrderStatusOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
          >
            <div className="absolute inset-0 bg-black/50" onClick={() => setIsOrderStatusOpen(false)} />
            <div className="relative z-10 w-full max-w-md">
              <OrderStatusPopup onClose={() => setIsOrderStatusOpen(false)} />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
